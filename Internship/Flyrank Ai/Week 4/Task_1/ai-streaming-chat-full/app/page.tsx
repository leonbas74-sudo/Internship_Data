...
setInput("Analyze https://example.com");
};
      ...
      {messages.length === 0 && !error && (
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-400 max-w-md">
            Ask me a question or give me a website URL.
            I can analyze website metadata and help you
                ...
                if (
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-gray-400">
                        The AI is preparing the website
                        metadata request.
                      </p>
                    </div>
                  );
    ...
    >
      ...
      {!input.trim() && (
        <p className="mt-2 text-center text-xs text-gray-500">
          Enter a message or click the example above
          to get started.
        </p>
      )}
    </div>
